...
// attention: to decompress some RAM is used. at least the decompressed size + 1024
// remember that we only have 128 KB of RAM. use it only, if there is enough RAM free ;)
// a possible solution for big files (sounds?) could be block by block decoding or maybe convert
// these huffman functions to support streaming ;)

#include <core/huffman.h>
#include <apps/huffman_testtext.h>
#include <core/lib.h>
#include <core/ui.h>

// this is the original huffman from bcl
/*************************************************************************
* Name:        huffman.c
* Author:      Marcus Geelnard
* Description: Huffman coder/decoder implementation.
* Reentrant:   Yes
* $Id: huffman.c 1101 2004-11-02 16:29:31Z geggo $
*
...
// as i have to mention, this is the altered part (down here)
//please notice that it's different from huffman_Uncompress! capital letter, hehe *g*
//needs some tweaking
void
huffman_decompress ( huffman_compressed hc, unsigned char *uncompressed )
{
    //uncompressed = (unsigned char*) malloc ( hc.uncompressed_size );
    //Huffman_Uncompress ( hc.blockname, uncompressed, hc.compressed_size, hc.uncompressed_size );
}

inline void
huffman_free ( unsigned char *uncompressed )
{
    //free ( uncompressed );
}

void
huffman_testtextdisplay ( void )
{
